...
from CocktaildbApp.models import Drink, Ingredient, Measure


class MeasureSerializer(serializers.ModelSerializer):

    ingredient = serializers.HyperlinkedRelatedField(view_name='CocktaildbApp:ingredient-detail',
...
class DrinkSerializer(serializers.HyperlinkedModelSerializer):
    ...
    url = serializers.HyperlinkedIdentityField(view_name='CocktaildbApp:drink-detail')
...
class IngredientSerializer(serializers.HyperlinkedModelSerializer):
    ...
    url = serializers.HyperlinkedIdentityField(view_name='CocktaildbApp:ingredient-detail')
